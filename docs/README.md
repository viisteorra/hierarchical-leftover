...
| [CLAIM.md](CLAIM.md) | The Hubble-tension sentence and the numbers |
| [HUBBLE.md](HUBBLE.md) | Scale accounting (inverse maps, forward CAMB) |
| [SOLVED.md](SOLVED.md) | Frozen solution table |
| [COMPLETE.md](COMPLETE.md) | What is in the theorem vs what is not remaining work |
