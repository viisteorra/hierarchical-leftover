...
from uniqueness import PERIOD_N, SEED, HYPER_STEPS, T_FRAC  # noqa: E402


def main() -> int:
    s = solution()
    print("SOLUTION  given P")
    print(f"  period {PERIOD_N}  seed {SEED}:{HYPER_STEPS}  Ω_DE={float(T_FRAC):.6f}={OMEGA_DE_TODAY:.6f}  w={W}")
